...
class AdminDashboardController(QObject):
    """Thin controller for the admin dashboard MVC flow."""
...
def build_admin_dashboard(user=None):
    """Create the admin dashboard with its controller already attached."""
    return AdminDashboardController().create_view(user=user)
